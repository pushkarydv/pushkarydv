...
\begin{tabularx}{\linewidth}{@{}m{0.8\textwidth} m{0.2\textwidth}@{}}
{
    ...
    \small{
        \clink{
            \href{mailto:pushkaryadavin@gmail.com}{pushkaryadavin@gmail.com} \textbf{·} 
            {\fontdimen2\font=0.75ex +918278622243} 
            \textbf{·} 
            \href{https://pushkaryadav.in}{pushkaryadav.in}
            \href{http://github.com/pushkarydv}{GitHub/pushkarydv}
            \href{https://www.linkedin.com/in/pushkarydv/}{LinkedIn/pushkarydv}
        } \newline
        New Delhi, India
    }
}
...
% left side %
{
    \csection{EXPERIENCE}{\small
        \begin{itemize}
            % item 1 %
            \item \frcontent{Zura Ventures}{Full Stack Intern (Apr 2023 - Aug 2023)}{Developed and maintained B2B Shopify apps that significantly increased sales revenue for Shopify merchants. Worked on multiple apps ranging form GiftKart, Easy Bundles, Kite Free Gift and other}
            % item 2 %
            \item \frcontent{Cosmofeed}{Software Engineering Intern (Nov 2022 - Dec 2022)}{Contributed to pre-release bio link app website, enhancing user experience, designed to gather data on potential target
            customers.}
        \end{itemize}
    }
